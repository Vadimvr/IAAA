...
ns.spellsAll = {
    ...
    Food = {
        { id = 57426, message = ns.create, event = SPELL_CREATE, print = false, say = false }, --  Рыбный пир
        { id = 57301, message = ns.create, event = SPELL_CREATE, print = false, say = false }, --  "Пир на весь мир"
        { id = 66476, message = ns.create, event = SPELL_CREATE, print = false, say = false }, --  Богатый пир
    },
    ICC25HM = {
