...
function MinimizeWindowsCombatLog:ADDON_LOADED(frameShow,func)
    ...
    MinimizeWindowsCombatLog.buttonMove =  CreateButton(self, ns.sizeButtons,offset_x,offset_y, "Interface\\Addons\\IAAA\\Textures\\icon-move.tga" , func)
...
function MinimizeWindowsCombatLog:NewPosition(point, relativeTo, relativePoint, xOfs, yOfs, height, width)
    ...
    elseif point == "LEFT" then
        MinimizeWindowsCombatLog:SetPoint("LEFT" ,xOfs + width , yOfs + (height / 2 - MinimizeWindowsCombatLog:GetHeight() /2))
        MinimizeWindowsCombatLog:GetThisPosition ()
        
    elseif point == "BOTTOMLEFT" then
        MinimizeWindowsCombatLog:SetPoint("BOTTOMLEFT",xOfs + width , yOfs + height  - MinimizeWindowsCombatLog:GetHeight())
        MinimizeWindowsCombatLog:GetThisPosition ()
    ...
    elseif point == "CENTER" then
        MinimizeWindowsCombatLog:SetPoint("CENTER",xOfs + width/2 +MinimizeWindowsCombatLog:GetWidth() /2, yOfs + height/2 - MinimizeWindowsCombatLog:GetHeight() /2)
        MinimizeWindowsCombatLog:GetThisPosition ()
    elseif point == "BOTTOM" then
        MinimizeWindowsCombatLog:SetPoint("BOTTOM",xOfs + width/2 +MinimizeWindowsCombatLog:GetWidth() /2, yOfs + height - MinimizeWindowsCombatLog:GetHeight())
        MinimizeWindowsCombatLog:GetThisPosition ()
    ...
    elseif point == "RIGHT" then
        MinimizeWindowsCombatLog:SetPoint("RIGHT",xOfs +MinimizeWindowsCombatLog:GetWidth(), yOfs + height/2 - MinimizeWindowsCombatLog:GetHeight() /2)
        MinimizeWindowsCombatLog:GetThisPosition ()
        
    elseif point == "BOTTOMRIGHT" then       
        MinimizeWindowsCombatLog:SetPoint("BOTTOMRIGHT",xOfs +MinimizeWindowsCombatLog:GetWidth()  , yOfs + height  - MinimizeWindowsCombatLog:GetHeight())
        MinimizeWindowsCombatLog:GetThisPosition ()
    end
...
function MinimizeWindowsCombatLog:Pos()
    ...
    ns.WindowCombatLog:NewPosition( point, relativeTo, relativePoint, xOfs, yOfs, MinimizeWindowsCombatLog:GetHeight(), MinimizeWindowsCombatLog:GetWidth())
end
